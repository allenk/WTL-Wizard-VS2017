...
function main()
{
	...
	// Allen K, using Files_15 for visual studio 2017 and later (maybe:( )
	var strSourceFolder15 = FileSys.BuildPath(strValue, "Files_15");
	if(bDebug)
		WScript.Echo("Source: " + strSourceFolder15);
	...
	// Allen K, rework for visualstudio 2017 release version
	astrRegKeyVer[8] = "Microsoft\\VisualStudio\\SxS\\VS7\\15.0";
