...
function OnFinish(selProj, selObj)
{
	try
	{
		...
		// Allen K, no more back support old wizard. works for 15 only
		...
		// Allen K, using default project creator
		//selProj = CreateCustomProject(strProjectName, strProjectPath);
		selProj = CreateProject(strProjectName, strProjectPath);
		// Allen K, add keywords for the project
		selProj.Object.Keyword = "WtlProj";
