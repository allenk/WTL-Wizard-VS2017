...
struct CharFormat : CHARFORMAT2
{
	...
	void operator <<(IPropertyStore* pStore)
	{
		...
		static void (CharFormat::*Getk_[])(IPropertyStore*) =
		{
			...
			&CharFormat::Getk_MaskEffect<CFM_BOLD, CFE_BOLD, reinterpret_cast<const PROPERTYKEY &>(UI_PKEY_FontProperties_Bold)>,
			&CharFormat::Getk_MaskEffect<CFM_ITALIC, CFE_ITALIC, reinterpret_cast<const PROPERTYKEY &>(UI_PKEY_FontProperties_Italic)>,
			&CharFormat::Getk_MaskEffect<CFM_UNDERLINE, CFE_UNDERLINE, reinterpret_cast<const PROPERTYKEY &>(UI_PKEY_FontProperties_Underline)>,
			&CharFormat::Getk_MaskEffect<CFM_STRIKEOUT, CFE_STRIKEOUT, reinterpret_cast<const PROPERTYKEY &>(UI_PKEY_FontProperties_Strikethrough)>,
			&CharFormat::Getk_VerticalPositioning,
			&CharFormat::Getk_Color<CFM_COLOR, reinterpret_cast<const PROPERTYKEY &>(UI_PKEY_FontProperties_ForegroundColor)>,
			&CharFormat::Getk_Color<CFM_BACKCOLOR, reinterpret_cast<const PROPERTYKEY &>(UI_PKEY_FontProperties_BackgroundColor)>,
			&CharFormat::Getk_ColorType<CFM_COLOR, CFE_AUTOCOLOR, UI_SWATCHCOLORTYPE_AUTOMATIC, reinterpret_cast<const PROPERTYKEY &>(UI_PKEY_FontProperties_ForegroundColorType)>,
			&CharFormat::Getk_ColorType<CFM_BACKCOLOR, CFE_AUTOBACKCOLOR, UI_SWATCHCOLORTYPE_NOCOLOR, reinterpret_cast<const PROPERTYKEY &>(UI_PKEY_FontProperties_BackgroundColorType)>,
		};
